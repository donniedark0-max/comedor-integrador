...
import numpy as np
import random
from google.genai import Client, types  # pip install google-genai
import sys

# --- Configure your Gemini API key ---
# Option 1: Set environment variable before running script:
os.environ["GENAI_API_KEY"] = "AIzaSyALyejM-qlnYCf1yz454TBszOkcd7sp7aI"
...
def main():
    ...
    if op == 1:
        df, cols = cargar_ingredientes("ingredientes2.csv")
        ...
        platos = generar_platos_completos("platos.csv")
        for p in platos:
            print(f"\n{p['Plato']}")
